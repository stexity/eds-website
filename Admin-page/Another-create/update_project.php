...
<div class="fom">
    ...
    <div class="user">
        <p class="nuim">Name</p>
        <input type="text" name="name" class="tex" value="<?php echo $name ?>">
    </div>
    <div class="user">
        <p class="nuim">Slogan</p>
        <input type="text" name="slogan" class="tex" value="<?php echo $slogan ?>">
    </div>
    <div class="user">
    ...
    <div class="user user2">
        ...
        <textarea class="tex tex1" name="desc" id="desc"  cols="30" rows="10" value="<?php $desc; ?>"></textarea>
...
$image = $_POST['image'];
$slogan = $_POST['slogan'];
$query = "UPDATE `project` SET `Name`='$name',`Description`='$desc',`Created_Date`='',`Images`='$image',`Images1`='',`Images2`='',`category_id`='',`slogan`='$slogan'
WHERE Id = '$id'";
 $run_query = mysqli_query($conn, $query);
